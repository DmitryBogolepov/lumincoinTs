...
export class IncomeExpense {
    ...
    async drawTable() {
        ...
        data.forEach((item, index) => {
            ...
            <td>${item.comment || '—'}</td>
            <td>
                <a href="javascript:void(0)" class="delete-icon text-decoration-none" id="delete-btn"><svg  width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="/change?id=${item.id}" class="redact-icon text-decoration-none"><svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    initDeleteButtons() {
        document.addEventListener("click", (event) => {
            ...
            if (deleteButton) {
                ...
                this.currentDeleteTarget = deleteButton.closest("tr");
