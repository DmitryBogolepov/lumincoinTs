    ...
    AuthUtils.getAuthInfo = function (key) {
        ...
        if (key && [this.accessTokenKey, this.refreshTokenKey, this.userInfoTokenKey].includes(key)) {
            ...
            return _a = {},
                ...
                _a[this.userInfoTokenKey] = localStorage.getItem(this.userInfoTokenKey),
                _a;
        }
    };
    AuthUtils.updateRefreshToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            var refreshToken, response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, fetch(config.api + "/refresh", {
                                method: "POST",
                                headers: {
                    ...
                    case 4:
                        error_1 = _a.sent();
                        console.error("Ошибка сети при обновлении токена:", error_1);
                        return [2 /*return*/, false];
