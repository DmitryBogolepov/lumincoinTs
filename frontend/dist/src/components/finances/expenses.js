...
var Expenses = /** @class */ (function () {
    function Expenses(openNewRoute) {
    ...
    Expenses.prototype.initDeleteButtons = function () {
        var _this = this;
        ...
        document.getElementById("confirmDelete").addEventListener("click", function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, HttpUtils.request("/categories/expense/".concat(this.currentDeleteId), "DELETE", true, null)];
                    case 2:
                        response = _a.sent();
                        if (!response.error) {
    ...
    Expenses.prototype.initEditButtons = function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                return [4 /*yield*/, this.openNewRoute("/expensesChange?id=".concat(id))];
                            case 1:
                                _a.sent();
                                _a.label = 2;
    ...
    Expenses.prototype.getAllExpenses = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, HttpUtils.request("/categories/expense", "GET", true, null)];
                    case 1:
                        result = _a.sent();
    ...
    Expenses.prototype.renderCards = function (items) {
